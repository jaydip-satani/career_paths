...
import 'package:career_paths/screens/sign_up/otp/verification%20sucess/resetpswd_success_screen.dart';
...
class _OtpFormState extends State<OtpForm> {
  //call api
  final SignupVerification = signupVerification();
  //show process
              ...
              : DefaultButton(
                  ...
                  press: () async {
                    if (val1.text.isNotEmpty &&
                      ...
                      final value = await SignupVerification.signupVerify(
                              widget.id, Full_otp)
                          .then((value) {
                        print(value);
                        if (value) {
